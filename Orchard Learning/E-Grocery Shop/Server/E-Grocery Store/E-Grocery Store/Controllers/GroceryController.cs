...
namespace E_Grocery_Store.Controllers
{
    ...
    public class GroceryController : ControllerBase
    {
        ...
        [HttpGet("admingroceries")]
        public async Task<ActionResult<Grocery>> GetAdminGroceries()
        {
            try
            {
                var groceries = await groceryRepo.GetAdminGroceries();
                return Ok(groceries);
            }
            catch (ResponseException ex)
            {
        ...
        [HttpPatch("reject")]
        public async Task<ActionResult<Response>> AdminRejectGrocery([FromBody] int id)
        {
            Response response;
            try
            {
                await groceryRepo.AdminRejectGrocery(id);
                response = new Response()
                {
                    IsSuccess = true,
                    Message = "Grocery rejected successfully"
                };
                return Ok(response);
            }
            catch (RequestException rex)
        ...
        [HttpPatch("accept")]
        public async Task<ActionResult<Response>> AdminAcceptGrocery([FromBody] int id)
        {
            Response response;
            try
            {
                await groceryRepo.AdminAcceptGrocery(id);
                response = new Response()
                {
                    IsSuccess = true,
                    Message = "Grocery approved successfully"
                };
                return Ok(response);
            }
            catch (RequestException rex)
